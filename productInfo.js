...
"Fiber Optic Patch Cable_SINGLEMODE SIMPLEX_FC TO FC":{
      ...
      "info":`Fiber Type:  Single mode Fiber 9/125um tight buffered duplex zip cord OS1 confirms to ITU-T G.652D standards with Outer Diameter - 2.0 mm and Outer Jacketed LSZH (Low Smoke Zero Halogen)`,
      ...
      <ul>
        ...
        <li>Connector: FC TO FC( Will change according to the product )</li>
        <li>FC TO FC</li>
      </ul>
    </div>
      <div class="box1">
        ...
        <ul>
          <li>Repeatability: < 0.10dB Storage </li>
          <li>temperature: -25°C to +70°C Operating</li>
          <li> Temperature: -20°C to +70°C Optical</li>
        </ul>
      </div>
      <div class="box1">
      ...
      <div class="box1">
        <h4> Applications</h4>
        <ul>
          <li>1) Data center & Computer networking</li>
          <li>2) Telecommunication & FTTH, FTTB & FTTX.</li>
          <li>3) CATV Systems, Local area networks (LAN), Wide area networks (WAN)</li>
          <li>4) Fiber optic testing equipment & sensors.</li>
          <li>5) Passive optical network & fiber communication system.</li>
        </ul>
      </div>
  ...
  "Fiber Optic Patch Cable_SINGLEMODE SIMPLEX_FC TO SC":{
    ...
    <ul>
      ...
      <li>Brand Name: OpZonik</li>
      <li> Country of Origin: India</li>
      <li>Connector: FC TO SC( Will change according to the product )</li>
      <li>FC TO SC</li>
    </ul>
  </div>
    <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: FC TO ST( Will change according to the product )</li>
    <li>FC TO ST</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: LC TO FC( Will change according to the product )</li>
    <li>LC TO FC</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: LC TO LC( Will change according to the product )</li>
    <li>LC TO LC</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: LC TO SC( Will change according to the product )</li>
    <li>LC TO SC</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: LC TO ST( Will change according to the product )</li>
    <li>LC TO ST</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: LCAPC TO SCAPC( Will change according to the product )</li>
    <li>LCAPC TO SCAPC</li>
  </ul>
</div>
  <div class="box1">
    <h4>Physical & Environmental Properties</h4>
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: SC TO SC( Will change according to the product )</li>
    <li>SC TO SC</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: SC TO ST( Will change according to the product )</li>
    <li>SC TO ST</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: SCAPC TO FC( Will change according to the product )</li>
    <li>SCAPC TO FC</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: SCAPC TO SC( Will change according to the product )</li>
    <li>SCAPC TO SC</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: SCAPC TO SCAPC( Will change according to the product )</li>
    <li>SCAPC TO SCAPC</li>
  </ul>
</div>
  <div class="box1">
    <h4>Physical & Environmental Properties</h4>
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: SCAPC TO ST( Will change according to the product )</li>
    <li>SCAPC TO ST</li>
  </ul>
</div>
  <div class="box1">
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: ST TO ST( Will change according to the product )</li>
    <li>ST TO ST</li>
  </ul>
</div>
  <div class="box1">
 ...
 "Fiber Optic Patch Cable_SINGLEMODE DUPLEX_ST TO ST":{
  ...
  <ul>
    ...
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: FCAPC TO FCAPC( Will change according to the product )</li>
    <li>FCAPC TO FCAPC</li>
  </ul>
</div>
  <div class="box1">
    <h4>Physical & Environmental Properties</h4>
  ...
  "info":`Fiber Type:Multimode Fiber OM1 62.5/125um is the tight buffered zip cord fiber and is designed to meet the demands of Gigabit Ethernet speeds and high speed fiber channel. It also supports 10 Gigabit Ethernet connection up to 33 meters. Cable Outer Diameter - 2.0 mm, and Jacketed LSZH (Low Smoke Zero Halogen) `,
...
"Fiber Optic Patch Cable_MULTIMODE OM2_LC TO LC":{
  "title":"OpZonik LC TO LC Fiber Optic Patch Cable Multimode OM1 Duplex 50/125µm Optical Patch Cord 1G/10G Fiber Optic Cable LC TO LC",
  "info":`Fiber Type:Multimode Fiber OM2 50/125um is the tight buffered zip cord fiber and is designed to meet the demands of Gigabit Ethernet speeds and high speed fiber channel. It also supports 10 Gigabit Ethernet connection up to 33 meters. Cable Outer Diameter - 2.0 mm, and Jacketed LSZH (Low Smoke Zero Halogen) `,
  "image":"../../public/image/buildings.png",
  "description":`<div class="descrip">
  <h2>Product Description</h2>
  <div class="box1">
  
  <ul>
    <li>Multimode OM2 50/125um Duplex Fiber Optic Patch Cord Cable.</li>
    <li>Brand Name: OpZonik</li>
    <li> Country of Origin: India</li>
    <li>Connector: LC TO LC( Will change according to the product )</li>
    <li>LC TO LC</li>
...
"Multifiber Pigtails_SINGLEMODE Multifiber Pigtail_SC 12 CORE":{
    ...
    <div class="box1">
      <h4>Specification</h4>
      <ul>
        <li>1. Lower Insertion Loss & High Return Loss. </li>
        <li>2. Environmentally Stable & Repeatability.</li>
        <li>3. 12 Color Mark - Splice-ready 900um buffered cables are color-coded according to industry standards for easy identification and the pre-terminated connectors at the opposite end are machine polished for optimal performance.</li>
        <li>4. Each cable is fully inspected and contains a test report. Our pigtails are also available with different connectors, polishes, strand counts and styles; like armored and waterproof.</li>
        <li>5. Eliminates troublesome Field Terminations</li>
      </ul>
    </div>
    <div class="box1">
      <h4> Parameters</h4>
      <ul>
        <li>1. Fiber Type: Single-Mode, Connector (s): SC Connector, Cable Length: 1.5M, Minimum Bending Radius: 3.8cm.</li>
        <li>2. Ferrule material: ceramic; Working Wavelength: 1310-1550nm</li>
        <li>3. Insertion loss: ≤0.3.</li>
        <li>4. Interchangeability: Operating temperature: -40 ~ +80; Storage temperature: -40 ~+85.</li>
      </ul>
    </div>
    <div class="box1">
      <h4> Application</h4>
      <p>Telecom and Datacom, Storage Network, CATV & Multimedia Application, Systems Integration for Long Haul, Metro and Access Network, Fiber to the Indoor (FTTX) Test.</p>
    </div>
    <div class="box1">
      <h4>Package Included </h4>
    <p>1 x 12 Strand Fiber Optic Pigtail Cable with 12 Strand SC-UPC Connectors which connect to the end equipment, like an adapter panel or optical transceiver.</p>
    </div>
...
"Multifiber Pigtails_SINGLEMODE Multifiber Pigtail_LC 12 CORE":{
  "title":"OpZonik 1.5M 12 Strand Singlemode 9/125um LC Fiber optic pigtails, 12 Color-Coded LC Cable Fiber Optic Patch Cord with Zirconia Ceramic Ferrule Plug for Fusion Splicing",
...
"Multifiber Pigtails_MULTIMODE Multifiber Pigtail OM1_SC":{
  "title":`OpZonik 1.5M 12 Strand Multimode OM1 62.5/125um SC Fiber optic pigtails, 12 Color-Coded SC Cable Fiber Optic Patch Cord with Zirconia Ceramic Ferrule Plug for Fusion Splicing `,
  "info":`1.5M SC Fiber Optic Pigtails are great for fusion splicing inside of a fiber optic enclosure. Each strand is terminated on one end and the other end is left blunt so that so it can be easily spliced to the trunk, backbone or outside plant cable and the other end is terminated with 12 SC Connectors which connect to the end equipment, like an adapter panel or optical transreceiver. It consists of a connector and a special length, connector could be SC, LC, FC, ST etc. <br><br>
...
"Multifiber Pigtails_MULTIMODE Multifiber Pigtail OM3_SC":{
  "title":`OpZonik 1.5M 12 Strand Multimode OM3 50/125um SC Fiber optic pigtails, 12 Color-Coded SC Cable Fiber Optic Patch Cord with Zirconia Ceramic Ferrule Plug for Fusion Splicing `,
  "info":`1.5M SC Fiber Optic Pigtails are great for fusion splicing inside of a fiber optic enclosure. Each strand is terminated on one end and the other end is left blunt so that so it can be easily spliced to the trunk, backbone or outside plant cable and the other end is terminated with 12 SC Connectors which connect to the end equipment, like an adapter panel or optical transreceiver. It consists of a connector and a special length, connector could be SC, LC, FC, ST etc.
  For Any Customization of length and connector configuration contact seller
...
//RACKMOUNT 
"Fiber Optic Rackmount Enclosure_SINGLEMODE_24 SC Port":{
  "title":`OpZonik 1U Fiber Optic Rackmount Enclosure, 24 Port SC Singlemode Fiber Optic Patch Panel Telescoping Sliding Style includes -  24 SC Singlemode Adapters, 24 SC Fiber Pigtails, Splice Trays upto 24 Fiber capacity – 19” Fiber Distribution Panel.

  
  `,
  "info":`OpZonik Fiber optic patch panel is also called fiber distribution panel. Its main function is to terminate the fiber optic cable and provide connection access to the cable’s individual fibers. Fiber patch panel are termination units, which are designed to provide a secure, organized chamber for housing connectors and splice units. The front opening of the optical fiber patch panel is easy pull out & push in telescoping sliding style and the top panel on the above which is removable for easy accessibility. <br> <br>
 `,
  ...
  <div class="box1">
    <h4></h4>
    <p> 1) OpZonik Fiber optic patch panel comes fitted with 24 SC Singlemode Simplex Adapters, 24 SC Fiber Optic Pigtails, Splice Trays for 24 Fiber Capacity. Includes 24 Splicing Sleeves, Cable Ties, Double sided tape, Nuts Bolt and mounting ear screws to fix and hold the incoming Fiber Optic Cables.
    <br>
    2) Provide space for the installation of optical cable terminals and storage of the remaining fiber, which is convenient for installation and operation. Rack mount enclosure provides with removable rubber grommets to protect the entry points of fiber at the rear of the unit.   <br>
  3) This rackmount Enclosure is made up of High quality cold rolled steel and comes in a Grey colour powder coated. The Dimensions for this panel are: H 1-3/4" x W 19” x D 12-1/4 standard solid structure.  <br>
  4) The device is flexible in configuration, easy to install and use, easy to maintain and manageable, and is an indispensable device for fiber optic cable terminal or relay node to realize fiber splice and jumper cable splice and access. The box with sufficient impact strength is fixed to facilitate installation in different occasions.</p>
   
  </div>
 
  <div class="box1">
    <h4> Application</h4>
    <p> 1)Telecommunication Network.</p>
    <p>2) Local Area Network (LANs) & Wide Area Network (WANs).</p>
    <p>3) FTTH, FTTB & FTTX</p>
    <p>4) Data processing Networks.</p>
    <p>5) CATV</p>
  </div>
...
"Fiber Optic Rackmount Enclosure_SINGLEMODE_24 LC Port":{
  "title":`OpZonik 1U Fiber Optic Rackmount Enclosure, 24 Port LC Duplex Singlemode Fiber Optic Patch Panel Telescoping Sliding Style includes -  24 LC DX Singlemode Adapters, 24 LC Fiber Pigtails, Splice Trays upto 24 Fiber capacity – 19” Fiber Distribution Panel.

  
  `,
  "info":`OpZonik 1U Fiber Optic Rackmount Enclosure, 24 Port LC Duplex Singlemode Fiber Optic Patch Panel Telescoping Sliding Style includes -  24 LC DX Singlemode Adapters, 24 LC Fiber Pigtails, Splice Trays upto 24 Fiber capacity – 19” Fiber Distribution Panel.
  OpZonik Fiber optic patch panel is also called fiber distribution panel. Its main function is to terminate the fiber optic cable and provide connection access to the cable’s individual fibers. Fiber patch panel are termination units, which are designed to provide a secure, organized chamber for housing connectors and splice units. The front opening of the optical fiber patch panel is easy pull out & push in telescoping sliding style and the top panel on the above which is removable for easy accessibility.
   <br> <br>
 `,
  ...
  <div class="box1">
    <h4></h4>
    <p> 1) OpZonik Fiber optic patch panel comes fitted with 24 LC Singlemode Duplex Adapters, 24 LC Fiber Optic Pigtails, Splice Trays for 24 Fiber Capacity. Includes 24 Splicing Sleeves, Cable Ties, Double sided tape, Nuts Bolt and mounting ear screws to fix and hold the Fiber Pigtails and Fiber Optic Cables.
    2) This rackmount Enclosure is made up of High quality cold rolled steel and comes in a Grey colour powder coated. The Dimensions for this panel are: H 1-3/4" x W 19” x D 12-1/4 standard solid structure.
    3) Provide space for the installation of optical cable terminals and storage of the remaining fiber, which is convenient for installation and operation. Rack mount enclosure provides with removable rubber grommets to protect the entry points of fiber at the rear of the unit. 
     4) The device is flexible in configuration, easy to install and use, easy to maintain and manageable, and is an indispensable device for fiber optic cable terminal or relay node to realize fiber splice and jumper cable splice and access. The box with sufficient impact strength is fixed to facilitate installation in different occasions
    </p>
...
"Fiber Optic Adapter_SINGLEMODE SIMPLEX_FC TO FC":{
  "title":"OpZonik FC Female to FC Female Singlemode Simplex Fiber Optic Cable Adapter / Coupler",
  "info":`
  FC compatible adapters are comprised of a nickel-plated body that is fitted with a precision alignment mechanism. These FC metal couplers are designed for mounting in standard round cut out style panels. Can be used with 2 FC single-mode or multi-mode fiber optic jumper cables. <br><br>
  ...
  Round with thread. The external reinforcement method is to use a metal sleeve. Generally used with optical distribution frames. Quick assembly FC connector can provide quick and easy termination of fibers in the field.
  `,
  "image":"../../public/opzonik_resize/New Adapter/New folder/FC-TO-FC-SX-S.MODE.png",
  "description":`<div class="descrip">
  <h2>Product Description</h2>
  <div class="box1">
    <h4> Features:</h4>
    <ul>
      <li>1) Insertion Loss: 0.2dB (1350nm & 1550nm)</li>
      <li> 2) High precision alignment.</li>
      <li>3) Good Interchangeability.</li>
      <li>4) Storage Temperature (-40°C~80°C)</li>
      <li>5) Repeatability 1000 Times</li>
    </ul>
  </div>
  <div class="box1">
    <h4> Applications</h4>
    <ul>
      <li>1) Fiber optic telecommunication system.
    
      
    
      </li>
      <li>2) Fiber optic transducer.</li>
      <li>3) CATV, FTTH, FTTB & FTTX Network.</li>
      <li> 4) Test equipment’s.</li>
    </ul>
  </div>

</div>`
},
"Fiber Optic Adapter_SINGLEMODE SIMPLEX_ST TO ST":{
  "title":"OpZonik ST Female to ST Female Singlemode Simplex Fiber Optic Cable Adapter / Coupler",
  "info":`ST-compatible adapters are comprised of a nickel-plated zinc die cast body fitted with a precision alignment mechanism. ST couplers series features multiple mounting options for 3/8” D hole and standard rectangular cut out style panels. <br><br>
  Additionally, these couplers can be used with PC or UPC style fiber connectors. <br><br>
  The combination of a ceramic alignment sleeves and a precision metal housing provides consistent long-term mechanical and optical performance.
  ...
  <div class="box1">
    ...
    <ul>
      ...
      <li>3) CATV, FTTH, FTTB & FTTX Network.</li>
      <li> 4) Test equipment’s.</li>
      <li>5) Fiber optic apparatus.</li>
    </ul>
  </div>

</div>`
},"Fiber Optic Adapter_SINGLEMODE SIMPLEX_SC TO SC":{
  "title":"OpZonik SC Female to SC Female Singlemode Simplex Fiber Optic Cable Adapter / Coupler ",
  "info":`
  SC compatible adapters are comprised of a polymer outer body and inner assembly fitted with a precision alignment mechanism.These couplers can be used with PC or UPC style fiber connectors. <br><br>

  The combination of a zirconia ceramic sleeves and a precision molded polymer housing provides consistent long term mechanical and optical performance.
  ...
  "info":`
  SCAPC compatible single mode adapters are comprised of a polymer outer body and inner assembly fitted with a precision alignment mechanism. These couplers can be used with PC or UPC style fiber connectors.<br><br>

  The combination of a zirconia ceramic sleeves and a precision moulded polymer housing provides consistent long term mechanical and optical performance.
...
},"Fiber Optic Adapter_SINGLEMODE DUPLEX_SC TO SC":{
  "title":"OpZonik SC Female to SC Female Singlemode Duplex Fiber Optic Cable Adapter / Coupler",
  "info":`
 
SC compatible duplex adapters are comprised of a polymer outer body and inner assembly fitted with a precision alignment mechanism.These couplers can be used with PC or UPC style fiber connectors.<br><br>
...
},"Fiber Optic Adapter_SINGLEMODE DUPLEX_LC TO LC":{
  "title":"OpZonik LC Female to LC Female Singlemode Duplex Fiber Optic Cable Adapter / Coupler",
  "info":`
  LC compatible duplex single mode adapters are comprised of a polymer outer body and inner assembly fitted with a precision alignment mechanism. These couplers can be used with PC or UPC style fiber connectors.<br><br>
...
"Fiber Optic Adapter_MULTIMODE SIMPLEX_SC TO SC":{
  "title":"OpZonik SC Female to SC Female Multimode Simplex Fiber Optic Cable Adapter / Coupler ",
  "info":`
  SC compatible Simplex Multimode adapters are comprised of a polymer outer body and inner assembly fitted with a precision alignment mechanism. These couplers can be used with PC or UPC style fiber connectors.<br><br>
...
},"Fiber Optic Adapter_MULTIMODE DUPLEX_SC TO SC":{
  "title":"OpZonik SC Female to SC Female Multimode Duplex Fiber Optic Cable Adapter / Coupler",
  "info":`
  SC compatible duplex multimode adapters are comprised of a polymer outer body and inner assembly fitted with a precision alignment mechanism. These couplers can be used with PC or UPC style fiber connectors.<br><br>
...
},"Fiber Optic Adapter_MULTIMODE DUPLEX_LC TO LC":{
  "title":"OpZonik LC Female to LC Female Multimode Duplex Fiber Optic Cable Adapter / Coupler ",
  "info":`
  LC compatible Duplex Multimode adapters are comprised of a polymer outer body and inner assembly fitted with a precision alignment mechanism. These couplers can be used with PC or UPC style fiber connectors. <br><br>
...
"Fiber Optic Adapter Cable_SINGLEMODE DUPLEX_LC TO ST":{
  ...
  <div class="box1">
    ...
    <ul>
      <li> 1) Connectors Type: LC Male TO SC Female Duplex</li>
      <li> 2) Fiber Type: Single mode Fiber 9/125um OS1 confirms to ITU-T G.652D standards.</li>
      <li>3) Cable Outer Diameter - 3.0mm and Jacketed LSZH (Low Smoke Zero Halogen)</li>
      <li>4) Fiber Wavelength: 1310nm</li>
      <li>5)Factory Termination & 100% test for link loss and return loss.</li>
    </ul>
  </div>
  <div class="box1">
    <h4> Applications</h4>
    <ul>
      <li>1) Testing equipment</li>
      <li>2)FTTX, LAN</li>
      <li>3) Optical fiber CATV.</li>
      <li> 4) Optical communication system</li>
      <li>5) Telecommunication.</li>
    </ul>
  </div>
...
"Fiber Optic Adapter Cable_SINGLEMODE DUPLEX_LC TO SC":{
  ...
  <div class="box1">
    ...
    <ul>
      <li> 1) Connectors Type: LC Male TO ST Female Duplex</li>
      <li> 2)Fiber Type: Single mode Fiber 9/125um OS1 confirms to ITU-T G.652D standards.</li>
      <li>3)Cable Outer Diameter - 2.0mm and Jacketed LSZH (Low Smoke Zero Halogen)</li>
      <li>4) Fiber Wavelength: 1310nm</li>
      <li>5)Factory Termination & 100% test for link loss and return loss.</li>
    </ul>
  </div>
  ...
  "info":``,
  "image":"../../public/opzonik_resize/Adapter Cables/New folder/LC-TO-SC-M.MODE-DX-ADAPTER-CABLE.png",
  "description":`<div class="descrip">
  <h2>Product Description</h2>
  <div class="box1">
    ...
    <ul>
      <li> 1) Connectors Type:  LC Male TO SC Female Duplex </li>
      <li> 2) Fiber Type: Multimode Fiber OM1 62.5/125um is the tight buffered zip cord fiber. </li>
      <li>3)Cable Outer Diameter - 3.0mm and Jacketed LSZH (Low Smoke Zero Halogen)</li>
      <li>4) Fiber Wavelength: 850nm</li>
      <li>5)Factory Termination & 100% test for link loss and return loss.</li>
    </ul>
  </div>
  <div class="box1">
...
},"Fiber Optic Adapter Cable_MULTIMODE DUPLEX_LC TO ST":{
  "title":"OpZonik 1FT LC to ST Fiber Optic Adapter Cable Multimode OM1 62.5/125 Duplex, LC Female to ST Male Fiber Adapter Cable – 0.3 Meter (1 FT)",
  "info":``,
  "image":"../../public/opzonik_resize/Adapter Cables/New folder/LC-TO-ST-M.MODE-DX-ADAPTER-CABLE.png",
  "description":`<div class="descrip">
  <h2>Product Description</h2>
  <div class="box1">
    
    <ul>
      <li> 1)Connectors Type: LC Female TO ST Male Duplex</li>
      <li> 2) Fiber Type: Multimode Fiber OM1 62.5/125um is the tight buffered zip cord fiber. </li>
      <li>3)    Cable Outer Diameter - 2.0mm and Jacketed LSZH (Low Smoke Zero Halogen)</li>
      <li>4) Fiber Wavelength: 850nm</li>
      <li>5)Factory Termination & 100% test for link loss and return loss.</li>
...
"Fiber Optic Patch Cable Armoured_ARMOURED CABLE_SCAPC TO LC":{
  ...
  "info":` Armoured fiber optic cable with build-in metal stainless steel tube provides stronger protection of the optical fibers than standards fiber optic cables. The rugged armored cables allow optical fiber to be installed in the most hazardous areas. <br><br>

  Fiber Type: Armoured Singlemode Fiber 9/125um OS2 confirms to ITU-T G.657A2 standards with Outer Diameter - 3.0 mm and Outer Jacketed LSZH (Low Smoke Zero Halogen)
  `,
  "image":"../../public/opzonik_resize/Armoured Cable/New folder/LC-TO-SCAPC-ARMOURED-CABLE.png",
  "description":`<div class="descrip">
  <h2>Product Description</h2>
      <div class="box1">
      ...
      <div class="box1">
        <h4> Applications</h4>
        <ul>
          <li>1)Ideal for use in vertical cabling of buildings and LAN</li>
          <li>2)Ideal for use in tails of backbone network, and connect from outdoors to indoors directly.</li>
          <li>3)  Ideal for use in connecting equipments, fix standard fiber to the linker.</li>
          <li>4) Routing Indoor Including Data Center Racks, Raised Floors and Runs between Floors.</li>
  ...
  Fiber Type: Armoured Singlemode Fiber 9/125um OS2 confirms to ITU-T G.657A2 standards with Outer Diameter - 3.0 mm and Outer Jacketed LSZH (Low Smoke Zero Halogen)`,
  "image":"../../public/opzonik_resize/Armoured Cable/New folder/SCAPC-TO-SCAPC-ARMOURED-CABLE.png",
  "description":`<div class="descrip">
  <h2>Product Description</h2>
  <h2>Product Description</h2>
  <div class="box1">
...
"Fiber Optic Hybrid Adapter_SINGLEMODE SIMPLEX_ST-LC":{
  ...
  <div class="box1">
    <h4> Applications</h4>
    <ul>
      <li>1) Fiber optic telecommunication system</li>
      <li>2) Fiber optic transducer</li>
      <li>3) CATV</li>
      <li>4) Test equipment’s</li>
      <li>5) Fiber optic apparatus</li>
...
"Fiber Optic Hybrid Adapter_SINGLEMODE SIMPLEX_FC-LC":{
  "title":"FC-LC HYBRID FIBER OPTIC ADAPTER",
  "info":`FC-LC hybrid adapters are designed for mounting pin panels with rectangular cut outs. This adapter features a bronze alignment sleeve which provides durability and resistance to cracking.  <br><br>
...
"Fiber Optic Attenuators _SINGLEMODE&MULTIMODE_SC":{
  ...
  <div class="box1">
    <h4>Feature  </h4>
    <ul>
      <li>Attenuation Tolerance:1310nm and 1550nm 850 nm 1-10dB<±1.0dB , 11-25dB<±1.5dB ,2dB, 5dB, 10dB <± 0.5dB</li>
      <li>Return Loss : RL≤ -50dB (UPC) , RL≤ -60 dB (APC)</li>
      <li>PDL : <0.1dB</li>
      <li>Fiber :  Multi-mode and Single-mode</li>
      <li> Attenuation (dB) :3, 5, 10, 15, 20, 25</li>
    </ul>
  </div>
  <div class="box1">
    <h4> Applications</h4>
    <ul>
      <li>1) Telecommunication networks</li>
      <li>2)  CATV</li>
      <li>3) LAN&WAN</li>
      <li>4)  Networking</li>
      <li>5)  Broadband</li>
      <li>6)  FTTX</li>
      <li>7)  WDM networks</li>
...
"Fiber Optic Attenuators _SINGLEMODE&MULTIMODE_LC":{
  ...
  LC attenuator feature a male connector at the front end and a female socket adapter at the back. Each attenuator is made with continues light absorbing and metal-ion doped fiber which provides excellent environmental stability and low back reflection. With this simple yet reliable structure, attenuators are added to the optical path without extra connectors.`,
...
//DISTRIBUTION CABLE
"Distribution Cable_SINGLEMODE_DISTRIBUTION CABLE":{
  "title":"DISTRIBUTION CABLE",
  "info":`A Distribution Cable consists of dry/ lubricated loose tubes that can hold anywhere between 4 – 96 , 900 microns fibres. The outer jacket comes in LSZH ( low smoke zero halogen ) or PVC.
...
"Breakout Cable_SINGLEMODE_12 FIBER":{
  ...
  We can provide you with just about any pre-terminated fiber cable you may need. Our technical wing can terminate multimode 62.5 or 50 micron (OM1, OM2, OM3, and OM4) as well as single mode fiber. Standard connector options include LC, SC, FC and ST. We can also terminate other connector types such as MTRJ, E2000, MU, DIN, D4, and SMA. Connector end available in both PC/APC type.`,
...
<ul>
  ...
  <li>10)   Single mode , multimode, Indoor/outdoor - armored & unarmored</li>
...
"Breakout Cable_SINGLEMODE_BREAKOUT CABLE":{
...
"Loopback Adapter Test Cable_SINGLEMODE_SC":{
  ...
  <div class="box1">
    <h4> Applications</h4>
    <ul>
      <li>1) Data center systems</li>
      <li>2) Fiber optic telecommunication system</li>
      <li>3) Fiber optic access network</li>
...
"Loopback Adapter Test Cable_SINGLEMODE_FC":{
  ...
  "info":`FC Loopback Adapter Test Cable are used primarily as a mean to test optical link in networks or devices by loop back the connections from the TX (transmit) pairs to the RX (receive) pair. <br><br>
...
"Loopback Adapter Test Cable_SINGLEMODE_4 FIBER MPO":{
  "title":"4 FIBER MPO LOOPBACK ADAPTER TEST CABLE",
  "info":`4,8,12,24 MPO/MTP Fiber Loopback are used primarily as a means to test optical link in networks or devices by looping back the connections from the TX (Transmit) pairs to the RX (Receive) pairs. By doing this, a complete optical link is formed, allowing the optical performance evaluation of a discrete component or complete link in a network path covering one or more interfaces . <br><br>

  Spectrum provides MTP/MPO loopback assemblies, which can pass rigid optical, mechanical, environmental test based on the GR-1435 requirements. And also complies with ROHS compliant.`,
  ...
  <ul>
  <li>Diameter : 3mm</li>
  <li>Product Type : MPO / MTP LOOP BACK</li>
  <li>Core Size : Single mode & Multimode</li>
  <li>Insertion Loss : Standard</li>
  <li>Cable Jacket : LSZH</li>
  <li>Number Of Fiber : 4,8,12,24</li>
